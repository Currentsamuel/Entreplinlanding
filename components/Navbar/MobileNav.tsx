...
const MobileNav = ({present} : any ) => {
    ...
    return (
      <div>
        <div className="w-full bg-white pt-4 fixed top-0 z-50 shadow left-0 right-0 flex flex-col md:hidden overflow-x-hidden">
          ...
          {show && (
            <div className="bg-white w-full flex flex-col items-center z-50 transition-all duration-1000 delay-1000 h-[90vh] ">
